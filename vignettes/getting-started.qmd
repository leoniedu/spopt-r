...
**Route optimization**: Find the best stop sequence for delivery drivers, field technicians, or any visit-based workflow. Single-vehicle routing with open routes and fixed endpoints (`route_tsp()`), or multi-vehicle dispatch with capacity constraints (`route_vrp()`). Bring a travel-time matrix from r5r, OSRM, or any routing engine; spopt handles the sequencing.
...
-   [Route Optimization](routing.html) - Optimize delivery routes and fleet dispatch with TSP and VRP
